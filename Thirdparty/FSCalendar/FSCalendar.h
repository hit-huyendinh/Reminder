...
/**
 * Asks the dataSource for a colors array in date
 */
- (NSArray<UIColor*>*) fsCalendar:(FSCalendar*)calendar eventColorsAtDate:(NSDate*)date;
/**
 * Asks the dataSource for a selected colors array in date
 */
- (NSArray<UIColor*>*) fsCalendar:(FSCalendar*)calendar selectedEventColorsAtDate:(NSDate*)date;
