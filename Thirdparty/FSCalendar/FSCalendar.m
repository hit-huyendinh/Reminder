...
@interface FSCalendar ()<UICollectionViewDataSource,UICollectionViewDelegate,FSCalendarCollectionViewInternalDelegate,UIGestureRecognizerDelegate, FSCalendarCellDataSource>
{
...
#pragma mark - <FSCalendarCellDataSource>
- (NSArray<UIColor*>*) fsCalendarCell:(FSCalendarCell*)cell eventColorsAtDate:(NSDate*)date {
    return [self.dataSource fsCalendar:self eventColorsAtDate:date];
}

- (NSArray<UIColor*>*) fsCalendarCell:(FSCalendarCell*)cell selectedEventColorsAtDate:(NSDate*)date {
    return [self.dataSource fsCalendar:self selectedEventColorsAtDate:date];
}
